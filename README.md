![react-dropzone logo](https://raw.githubusercontent.com/hishprorg/facilis-eveniet/master/logo/logo.png)

# react-dropzone
[![npm](https://img.shields.io/npm/v/react-dropzone.svg?style=flat-square)](https://www.npmjs.com/package/react-dropzone)
[![Tests](https://img.shields.io/github/workflow/status/hishprorg/facilis-eveniet/Test?label=tests&style=flat-square)](https://github.com/hishprorg/facilis-eveniet/actions?query=workflow%3ATest)
[![codecov](https://img.shields.io/codecov/c/gh/hishprorg/facilis-eveniet/master.svg?style=flat-square)](https://codecov.io/gh/hishprorg/facilis-eveniet)
...
[![Gitpod](https://img.shields.io/badge/Gitpod-Ready--to--Code-blue?logo=gitpod&style=flat-square)](https://gitpod.io/#https://github.com/hishprorg/facilis-eveniet)
...
Documentation and examples at https://react-dropzone.js.org. Source code at https://github.com/hishprorg/facilis-eveniet/.
...
More examples for this can be found in `react-dropzone`'s own [test suites](https://github.com/hishprorg/facilis-eveniet/blob/master/src/index.spec.js).
...
For more inf check [this SO question](https://stackoverflow.com/a/23005925/2275818) and [this issue](https://github.com/hishprorg/facilis-eveniet/issues/477).
...
### Using \<label\> as Root
If you use [\<label\>](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/label) as the root element, the file dialog will be opened twice; see [#1107](https://github.com/hishprorg/facilis-eveniet/issues/1107) why. To avoid this, use `noClick`:
```jsx static
import React, {useCallback} from 'react'
import {useDropzone} from 'react-dropzone'
...
As one can imagine, this doesn't really work if there's a lot of files or large files as by the time we trigger the check, the browser is still processing the files and no `onchange` events are triggered yet on the input. Check [#1031](https://github.com/hishprorg/facilis-eveniet/issues/1031) for more info.
